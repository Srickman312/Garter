snake.gart02 = function() { // creates mod menu
  ...
  x0.style = "padding:16px 16px; font-size:16px;  display:inline-block; border:2px solid rgb(200,0,0); color:rgb(255,255,255); background-color:rgb(255,0,0); text-align: center";
  ...
  x1.style = "padding:16px 16px; font-size:16px;  display:inline-block; border:2px solid rgb(200,0,0); color:rgb(255,255,255); background-color:rgb(255,0,0); text-align: center";
